...
Full fleet simulation — 20 venues, 5 scenarios, mono-vibe corrected architecture
...
```bash
git clone https://github.com/SuperInstance/grand-pattern-sim
cd grand-pattern-sim
```
